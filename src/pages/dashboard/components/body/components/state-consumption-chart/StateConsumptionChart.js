...
import style from './StateConsumptionChart.module.sass'
...
const StateConsumptionChart = () => {
    const history = useHistory();
    function generateChart(result) {
        let chart = am4core.create("stateConsumptionChart", am4charts.XYChart);
        chart.rtl = true;
        chart.data = result;
    ...
    return (
        <>
            <div className={style.stateConsumption}>
                <div className="white_container">
                    <div className="container_head text_right">
                        <h3>نمودار مصرف دستگاه های تابعه وزارت نیرو</h3>

                    </div>
                    <Divider />
                    <div className={style.chartArea}>
                        <div id="stateConsumptionChart" className={style.stateConsumptionChart}></div>
                    </div>
                </div>
...
export default StateConsumptionChart;
